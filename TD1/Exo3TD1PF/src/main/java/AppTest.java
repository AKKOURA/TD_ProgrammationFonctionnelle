...
public class AppTest {
      public static final Arbre arbre0() {
        return new Noeud(new ArrayList<>());
    }
    ...
    private void assertEquals(int i , int taille) {
        
    }

    private void assertFalse(boolean contient) {
        
    }

    private void assertTrue(boolean estTrie) {
     
    }

    private void assertEquals(Object object, Integer min) {
